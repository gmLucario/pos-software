//! Sale Receipt Modal Component
//!
//! Modal dialog for displaying sale receipts with print functionality.
    ...
    rsx! {
        ...
        div {
            ...
            div {
                ...
                // Success message
                div {
                    style: "background: #f0fff4; color: #22543d; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1.5rem; border: 1px solid #48bb78; text-align: center;",
                    div {
                ...
                div {
                    ...
                    if sale.is_loan {
                        div {
                            style: "display: flex; justify-content: space-between; padding-top: 0.5rem; border-top: 1px solid #e2e8f0; margin-top: 0.5rem;",
                            span { style: "font-weight: 600; color: #c53030;", "Amount Owed:" }
                            span { style: "font-weight: 700; color: #c53030; font-family: monospace;", "{format_currency(sale.total_amount - sale.paid_amount)}" }
                        }
                    }
                }
